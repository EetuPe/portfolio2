      ...
      <section className="py-12 px-12 flex flex-col text-center gap-8">
        <Card>
          ...
          <CardContent className="flex justify-center items-center">
            <Image className="rounded md:w-3/5 sm:w-full h-auto shadow-md" src={produni} alt={"Produni"} />
          </CardContent>
        ...
        <Card>
          ...
          <CardContent className="flex justify-center items-center">
            <Image className="rounded md:w-3/5 sm:w-full h-auto shadow-md" src={mentis} alt={"Mentis"} />
          </CardContent>
          <CardFooter className="flex-col justify-center items-center gap-6">
            <div className="flex gap-2 items-center justify-center">
            <a
        ...
        <Card>
          ...
          <CardContent className="flex justify-center items-center">
            <Image className="rounded md:w-3/5 sm:w-full h-auto shadow-md" src={multitool} alt={"Multitool"} />
          </CardContent>
          <CardFooter className="flex-col justify-center items-center gap-6">
            <div className="flex gap-2 items-center justify-center">
            <a
        ...
        <Card>
          ...
          <CardContent className="flex justify-center items-center">
            <Image className="rounded md:w-3/5 sm:w-full h-auto shadow-md" src={skipp5} alt={"Skipp-5"} />
          </CardContent>
          <CardFooter className="flex-col justify-center items-center gap-6">
            <div className="flex gap-2 items-center justify-center">
            <Badge className="py-2 px-4 shadow-md no-underline rounded-full bg-secondary-foreground text-primary font-sans font-semibold text-sm border-blue btn-primary hover:text-white hover:bg-blue-light focus:outline-none active:shadow-none mr-2">{`</>`}</Badge>
